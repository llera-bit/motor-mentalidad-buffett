...
Buffett aplica al reparto de beneficios la misma lógica que un bonista sensato: solo
conviene retener si el capital se reinvierte a un rendimiento superior al disponible fuera;
si no, hay que repartirlo.

> "Logically, a company with historic and prospective high returns on equity should retain
> much or all of its earnings so that shareholders can earn premium returns on enhanced
> capital. Conversely, low returns on corporate equity would suggest a very high dividend
> payout so that owners could direct capital toward more attractive areas." — 1981

El paralelo con el bonista: nadie reinvierte los cupones de un bono al 5% comprando más
bonos al 5% a la par cuando hay equivalentes al 40% de su valor. No se echa dinero bueno
sobre malo.

> "Good money is not thrown after bad." — 1981

La perversión inflacionaria es que el negocio de bajo rendimiento se ve obligado a retener
todo lo que puede —precisamente por ser malo—, solo para mantener el volumen del año
anterior.
...
En 1984 desarrolla la política de dividendos distinguiendo dos clases de beneficio. Los
"restringidos" (que la inflación obliga a reinvertir solo para mantener el volumen) apenas
valen para el dueño. Los "no restringidos" son los que de verdad se pueden retener o
repartir, y la regla es una:

> "Unrestricted earnings should be retained only when there is a reasonable prospect... that
...
Y su corolario sobre la rendición de cuentas:
